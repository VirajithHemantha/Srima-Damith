...
function Countdown() {
  const targetDate = new Date("2026-08-01T09:30:00").getTime();
                  ...
                  <div className="relative z-10 px-4 pt-4 pb-3 sm:px-6 sm:pt-7 sm:pb-7 md:px-10 md:py-8 flex flex-col items-center text-center gap-0 sm:gap-2 md:gap-3">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="serif text-[10px] sm:text-[11px] md:text-[13px] uppercase tracking-[0.3em] text-umber font-bold md:font-normal leading-relaxed">
                        MR. E.M. SUNIL EKANAYAKE & MRS. B.M. ANULA RANJANI
                      </p>
                      <p className="text-[9px] sm:text-[10px] md:text-[11px] uppercase tracking-[0.25em] text-taupe font-medium">
                        &
                      </p>
                      ...
                      <p className="serif text-[10px] sm:text-[11px] md:text-[13px] uppercase tracking-[0.3em] text-umber font-bold md:font-normal leading-relaxed">
                        MR. I.G. WIJERATHNA & MRS. D.M. KUSUMAWATHI
                      </p>
                    </div>
                    ...
                    <p className="serif mb-2.5 sm:mb-0 text-[11px] sm:text-[12px] md:text-[14px] uppercase tracking-[0.2em] text-taupe/80 font-bold md:font-normal leading-relaxed max-w-[220px] md:max-w-xs">
                      REQUEST THE PLEASURE OF YOUR COMPANY TO CELEBRATE THE HOMECOMING OF THEIR CHILDREN
                    </p>
              ...
              <div className="w-full h-full bg-white p-2 md:p-8 flex flex-col items-center justify-center text-center space-y-2 md:space-y-4 relative group">
                ...
                <div className="relative z-10 space-y-2 md:space-y-8 scale-[0.9] md:scale-100">
                  <div className="space-y-1">
                    <span className="serif italic text-[18px] md:text-3xl text-umber/90 font-bold">Our Homecoming Date</span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="serif text-lg md:text-3xl font-bold tracking-[0.2em] mt-2 md:mt-3 text-umber">AUGUST</p>
                  </div>
                ...
                <div className="w-full h-full relative group">
                  ...
                  <div className="absolute top-6 right-6 md:top-10 md:right-10 bg-white/60 backdrop-blur-md p-4 md:p-8 border border-white/60 rounded-2xl group-hover:bg-white/80 transition-all duration-700 shadow-xl">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => window.open("https://maps.app.goo.gl/SKKQ9hn45qJDkhFH7", "_blank")}
                  ...
                  <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 text-sage flex items-center gap-3 bg-white/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/60 shadow-lg">
                    ...
                    <p className="serif text-[10px] md:text-sm tracking-[0.2em] font-bold uppercase">At Home</p>
                  </div>
                </div>
              }
              back={
                <>
                  ...
                  <h4 className="serif text-2xl md:text-4xl text-sage mb-2 md:mb-4">At Home</h4>
                ...
                <div className="w-full h-full flex flex-col justify-center items-center px-4 md:px-8">
                  ...
                  <div className="w-full max-w-sm space-y-4 md:space-y-6 text-left">
                    <div className="flex items-start gap-2 md:gap-4">
                      <span className="serif text-sage font-bold text-[10px] md:text-base w-12 md:w-20 text-right shrink-0 pt-1">9:30 AM</span>
                      ...
                      <div>
                        ...
                        <p className="serif text-[10px] md:text-xs italic text-zinc-500">Gathering at Home</p>
                      </div>
                    </div>

                    <div className="flex items-start gap-2 md:gap-4">
                      <span className="serif text-sage font-bold text-[10px] md:text-base w-12 md:w-20 text-right shrink-0 pt-1">10:30 AM</span>
                      <div className="w-px h-full bg-sage/30 relative mt-2 -ml-[1px] md:-ml-2 shrink-0">
                        <div className="absolute top-0 -left-[3px] w-2 h-2 rounded-full bg-sage" />
                      </div>
                      <div>
                        <p className="text-[10px] md:text-xs font-bold uppercase tracking-wider">Traditional Rituals</p>
                        <p className="serif text-[10px] md:text-xs italic text-zinc-500">Joyous Moments</p>
                      </div>
                    </div>

                    <div className="flex items-start gap-2 md:gap-4">
                      <span className="serif text-sage font-bold text-[10px] md:text-base w-12 md:w-20 text-right shrink-0 pt-1">12:30 PM</span>
                      <div className="w-px h-full bg-sage/30 relative mt-2 -ml-[1px] md:-ml-2 shrink-0">
                        <div className="absolute top-0 -left-[3px] w-2 h-2 rounded-full bg-sage" />
                      </div>
                      <div>
                        <p className="text-[10px] md:text-xs font-bold uppercase tracking-wider">Lunch & Celebration</p>
                        <p className="serif text-[10px] md:text-xs italic text-zinc-500">Feast & Dance</p>
                      </div>
                    </div>

                    <div className="flex items-start gap-2 md:gap-4">
                      <span className="serif text-sage font-bold text-[10px] md:text-base w-12 md:w-20 text-right shrink-0 pt-1">4:00 PM</span>
                      <div className="w-px h-full bg-sage/30 relative mt-2 -ml-[1px] md:-ml-2 shrink-0">
                        <div className="absolute top-0 -left-[3px] w-2 h-2 rounded-full bg-sage" />
                      </div>
                      <div>
                        <p className="text-[10px] md:text-xs font-bold uppercase tracking-wider">Farewell</p>
                        <p className="serif text-[10px] md:text-xs italic text-zinc-500">End of the celebration</p>
                      </div>
                    </div>
                  </div>
                </div>
